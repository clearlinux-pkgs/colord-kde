...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/colord-kde-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/colord-kde-24.12.2.tar.xz.sig
...
%setup -q -n colord-kde-24.12.2
cd %{_builddir}/colord-kde-24.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738955895
mkdir -p clr-build
pushd clr-build
