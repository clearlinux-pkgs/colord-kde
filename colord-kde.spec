...
Version  : 25.04.0
Release  : 21
URL      : https://download.kde.org/stable/release-service/25.04.0/src/colord-kde-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/colord-kde-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/colord-kde-25.04.0.tar.xz.sig
...
%setup -q -n colord-kde-25.04.0
cd %{_builddir}/colord-kde-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744915821
mkdir -p clr-build
pushd clr-build
