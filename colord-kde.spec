...
Version  : 24.05.1
Release  : 9
URL      : https://download.kde.org/stable/release-service/24.05.1/src/colord-kde-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/colord-kde-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/colord-kde-24.05.1.tar.xz.sig
...
%setup -q -n colord-kde-24.05.1
cd %{_builddir}/colord-kde-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718391687
mkdir -p clr-build
pushd clr-build
