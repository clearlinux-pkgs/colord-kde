...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/colord-kde-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/colord-kde-24.05.0.tar.xz.sig
...
%setup -q -n colord-kde-24.05.0
cd %{_builddir}/colord-kde-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716511712
mkdir -p clr-build
pushd clr-build
