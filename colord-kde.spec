...
Version  : 25.04.1
Release  : 22
URL      : https://download.kde.org/stable/release-service/25.04.1/src/colord-kde-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/colord-kde-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/colord-kde-25.04.1.tar.xz.sig
...
%setup -q -n colord-kde-25.04.1
cd %{_builddir}/colord-kde-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747095671
mkdir -p clr-build
pushd clr-build
