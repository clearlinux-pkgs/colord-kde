...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/colord-kde-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/colord-kde-25.04.2.tar.xz.sig
...
%setup -q -n colord-kde-25.04.2
cd %{_builddir}/colord-kde-25.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749494970
mkdir -p clr-build
pushd clr-build
