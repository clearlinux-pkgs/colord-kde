...
Version  : 23.08.4
Release  : 2
URL      : https://download.kde.org/stable/release-service/23.08.4/src/colord-kde-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/colord-kde-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/colord-kde-23.08.4.tar.xz.sig
...
%prep
%setup -q -n colord-kde-23.08.4
cd %{_builddir}/colord-kde-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707783752
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/qt5/plugins/kf5/kded/colord.so
/usr/lib64/qt5/plugins/plasma/kcms/systemsettings/kcm_colord.so
