...
Version  : 24.12.3
Release  : 20
URL      : https://download.kde.org/stable/release-service/24.12.3/src/colord-kde-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/colord-kde-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/colord-kde-24.12.3.tar.xz.sig
...
%setup -q -n colord-kde-24.12.3
cd %{_builddir}/colord-kde-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742442731
mkdir -p clr-build
pushd clr-build
