...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/colord-kde-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/colord-kde-24.02.1.tar.xz.sig
...
%prep
%setup -q -n colord-kde-24.02.1
cd %{_builddir}/colord-kde-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711205760
mkdir -p clr-build
pushd clr-build
