...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/colord-kde-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/colord-kde-24.02.2.tar.xz.sig
...
%setup -q -n colord-kde-24.02.2
cd %{_builddir}/colord-kde-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712869717
mkdir -p clr-build
pushd clr-build
